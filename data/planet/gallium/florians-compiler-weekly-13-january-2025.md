...
<span><a href="http://gallium.inria.fr/blog/index.rss#cb1-2" aria-hidden="true" tabindex="-1"></a>| effect Random_float, k -&gt; <span class="dt">Effect</span>.Deep.continue k (<span class="dt">Random</span>.<span class="dt">float</span> <span class="dv">1</span>.)</span>
